...
$(document).ready(function () {
	...
	$("#schoolName").dblclick(function(){
		...
		$("#saveChanges").click(function(){
			...
			if($(this).attr("style[text-align]")!=undefined){
				
				var csst="#"+$(this).attr("id")+"{text-align:"+$(this).attr("style[text-align]")+"}";
				cssgroup.push(csst);
		}
		else{
			var carryCsst="#"+$(this).attr("id")+"{text-align:"+$(this).css('text-align')+"}";
			cssgroup.push(carryCsst);
		}
...
function getStudentIdDesignList(){
	$.ajax({
		type:"POST",
		url:"EventsMenu.html?method=getEventIdDesignList",
		async:false,
