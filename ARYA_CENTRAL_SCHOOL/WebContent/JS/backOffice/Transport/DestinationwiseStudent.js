...
$(document)
		.ready(
				function() {
					...
					if(urlLink=="adminMenu.html?method=studentDestList"){
					...
					.click(
							function() {
								...
								window.location.href = 'adminMenu.html?method=destinationWiseStudentXL';
								
							});
					$("#pdfDownload").click(function(){
            			
            			window.location.href = "adminMenu.html?method=destinationWiseStudentDetailsPDF"
