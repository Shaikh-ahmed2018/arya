...
frameDoc.document.write('<style>#wrap p{font-size:16px;line-height:1.5;margin:0 !important;}#wrap{width:80%;margin:auto;}</style>');
frameDoc.document.write('</head><body>');

//Append the DIV contents.
frameDoc.document.write('<div id="wrap">'+'<table align="center" style="margin-top:100px;"><tr><td><h3 class="age" style="margin-bottom:100px;">COURSE CERTIFICATE</h3></td></tr>'+
		'<tr><td><p>This is to certify that&nbsp'+heading+'&nbsp&nbsp<u>&nbsp&nbsp'+stuname+'&nbsp&nbsp</u>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'+rel+'&nbspof</p></td></tr>'+
		'<tr><td><p>Shri/Smt &nbsp&nbsp<u>&nbsp&nbsp'+fathername+'&nbsp'+motherName+'&nbsp&nbsp</u>&nbsp&nbspis a bonafied student of this school</p></td></tr>'+
		'<tr><td><p>studying in std&nbsp&nbsp<u>&nbsp&nbsp'+classname+'&nbsp&nbsp</u>for the ICSC/ISC/SSLC/HSC course during the academic year&nbsp&nbsp<u>&nbsp&nbsp'+accyear +'&nbsp&nbsp</u>&nbsp.'+rel1+'&nbspcharacter and conduct</p></td></tr><tr><td><p>during her study in this school have been.</p></td></tr></table>'+
		'<table width="100%" style="margin-top:100px;"><tr><td><h5 align="left">Date</h5></td><td><h5 align="center">Seal</h5></td><td><h5 align="right">Principal</h5></td></tr></table>'+
'</div>');
