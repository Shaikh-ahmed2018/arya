$(document).ready(function(){
	...
	$("#allstudent tbody tr").click(function(){
		...
		//window.location.href="adminMenu.html?method=individualMisreport&studentId="+student_Id[0]+"&accyear="+student_Id[1]+"&locationId="+student_Id[2];
...
function rowclick(studentId,accyear,locationId){
	window.open(
			  "adminMenu.html?method=individualMisreport&studentId="+studentId+"&accyear="+accyear+"&locationId="+locationId,
