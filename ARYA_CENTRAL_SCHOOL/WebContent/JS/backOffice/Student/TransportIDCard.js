...
function getIdCardStreamList(){
	...
	$.ajax({
		url : "adminMenu.html?method=TransportIDCardDesignList",
		data:dataList,
		async : false,
		success : function(data) {
...
function rowClickable(){
	$("#allstudent tbody tr").click(function(){
		...
		window.location.href="adminMenu.html?method=PrintTransportIDCard&accyear="+$(this).attr("class").split(" ")[0]+"&schoolId="+$(this).attr("class").split(" ")[1]+"&streamId="+$(this).attr("class").split(" ")[2];
