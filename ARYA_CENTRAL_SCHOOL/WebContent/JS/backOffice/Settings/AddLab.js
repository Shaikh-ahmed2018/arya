  ...
  if($("#hiddenlocationid").val()!="" & $("#hiddenlocationid").val()!=null )
  {
	...
	$('#save').click(function() 
 		...
 		var pm=$("#passMarks").val();
							...
							$(".errormessagediv").show();
							var  classname = $("#classname").val(), lab_name=$("#lab_name").val(), subject = $("#subject").val(), file = $("#file").val(), description = $("#description").val();
							var locationId=$("#locationname").val();
						    ...
						    else if($("#specialization").val() == "-" && spelen > 0){
                           	 $(".errormessagediv").show();
      							$(".validateTips").text("Select specialization..");
                             ...
                             else if(lab_name=="")
                         	{
                             ...
                             else if(lab_name.length < 1)
      						{
								...
								setTimeout(function() {
                            	 ...
                            	 $(".errormessagediv").show();
       							$(".validateTips").text("Total Marks should be greater than zero");
       							showError("#totalMarks");
								setTimeout(function() {
									$('.errormessagediv').fadeOut();
								}, 2000);
								...
								setTimeout(function() {
                            	 ...
                            	 {
                            	 $(".errormessagediv").show();
       							$(".validateTips").text("Pass Marks should be greater than zero");
       							showError("#passMarks");
								setTimeout(function() {
									$('.errormessagediv').fadeOut();
								}, 2000);
