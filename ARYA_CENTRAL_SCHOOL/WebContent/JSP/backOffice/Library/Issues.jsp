...
<body>
	<div class="col-md-10 col-md-offset-2" id="div-main"
		...
		<p>
			<img src="images/addstu.png" /><span id="pageHeading">Issued</span>
		</p>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="LIBTADD" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<span class="buttons back" id="back">Back</span>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
						...
						<div class="row">
							<div class="col-md-6"
								...
								<div class="form-group clearfix">
									...
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right;"> Issued to</label>
									...
									<div class="col-xs-7">
										<div
											...
											<%-- <div style="position: absolute; top: 0; height: 160px;">
												 <input type="file" id="teacherImage" name="teacherImage"
													class="form-control" value="<logic:present name='studentList' scope='request'><bean:write name='studentList' property='imageUrl'/></logic:present>"
