...
<script type="text/javascript"
	src="JS/backOffice/Library/SearchsubscriberDetails.js"></script>
					...
					<div class="row">
						...
						<div class="col-md-6"
							...
							<fieldset class="fieldset1">
								<legend
									style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; color: #767676; margin-left: 46px;">Order
									By:</legend>
