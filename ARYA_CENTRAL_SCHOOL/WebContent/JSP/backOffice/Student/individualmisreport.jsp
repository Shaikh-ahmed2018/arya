	...
	<div class="col-md-10 col-md-offset-2" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
					...
					<h4 class="panel-title" style="color: #767676; vertical-align: text-top;"> 
						...
						<div class="panel-body own-panel">
							...
							<div class="col-md-6" style="font-family: Open Sans Light; font-size: 11pt; color: #5d5d5d;margin-top: 10px;">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" name="houseId" 	onkeypress="HideError()" id="houseId" class="form-control" readonly="readonly" 
...
<!-- 									<div class="col-xs-7"> -->
<!-- 										<select name="examcodes" onkeypress="HideError()" id="examcodes" class="form-control"></select> -->
<!-- 									</div> -->
<!-- 									</div> -->
								</div>
								    </div>
									<div id="feedetailtable" style="padding: 5px"></div>
