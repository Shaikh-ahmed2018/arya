					...
					<div id="admissionDialog" style="display: none">
						...
						<div class="col-md-6"
							...
							<div class="form-group clearfix">
								...
								<div class="col-xs-7">
									<input class="form-control" onkeypress="HideError()" style="Width:150%;"  
							...
							<div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-5"
									style="text-align: left;">Comment</label>
								<div class="col-xs-7">
									<textarea style="border: 1px solid #ccc;"  name="comment" id="comment" rows="2" cols="30"></textarea>
						...
						<div class="col-md-6"
							...
							<div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-5"
									style="text-align: left;">Entry Date</label>
								<div class="col-xs-7">
									<input class="form-control" onkeypress="HideError()" style="Width:150%;" readonly="readonly"
							...
							<div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-5"
									style="text-align: left;">Comment</label>
								<div class="col-xs-7">
									<textarea style="border: 1px solid #ccc;"  name="comment" id="editcomment" rows="2" cols="30"></textarea>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h4 class="panel-title"><i	class="glyphicon glyphicon-menu-hamburger"></i>	&nbsp;&nbsp;Disciplinary Action</h4></a>
