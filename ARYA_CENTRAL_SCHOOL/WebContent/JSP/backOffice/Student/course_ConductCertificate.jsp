...
<body>
	...
	<div class="col-md-10 col-md-offset-2" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		<p><img src="images/addstu.png" /><span id="pageHeading">Course & Conduct Certificate</span></p>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h4 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Course & Conduct Certificate
							</h4></a>
						...
						<div class="navbar-right">
							...
							<span id="back" class="buttons" style="top:4px;">Back</a></span>
						</div>
					...
					<input type="hidden" id="dob" value="<logic:present name="stuList"><bean:write name="stuList" property="dob"/></logic:present>"/>			
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" name="conductno" id="conductno" class="form-control" onkeypress ="return isNumberKey(event);"/>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" 	id="purpose" maxlength="25" class="form-control" />
									</div>
								</div>
							...
							<div class="col-md-6" style="font-family: Open Sans Light; font-size: 11pt; color: #5d5d5d;margin-top: 10px;">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" name="conduct"  id="conduct" maxlength="25" class="form-control" 
