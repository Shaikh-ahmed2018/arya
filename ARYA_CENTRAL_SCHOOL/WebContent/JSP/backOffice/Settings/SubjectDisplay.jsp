		...
		<div class="panel panel-primary">
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#subjectOne" style="color: #fff;"><h3
						class="panel-title" style="color: #767676;">
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Subject Details
					</h3></a>
						   ...
						   <logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="SUBUPD" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
						<span id="editsubject" class="buttons">Edit</span>
						</logic:equal>
						</logic:equal>
						</logic:iterate>
						</logic:present>
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<logic:present name="allsubjects" scope="request">
						...
						<tr>
						<td><input type='checkbox' name='select' class='select' style='text-align:center' id='<bean:write name='allsubjects' property="subjectid"/>,<bean:write name='allsubjects' property="locationId"/>' /></td>
						<td><bean:write name='allsubjects' property="locationName" /></td>
						<td><bean:write name='allsubjects' property="classname" /></td>
						<td><bean:write name='allsubjects' property="specializationName" /></td>
						<td><bean:write name='allsubjects' property="subjectname" /></td>
						<td><bean:write name='allsubjects' property="totalMarks" /></td>
						<td><bean:write name='allsubjects' property="passMarks" /></td>
						<td><bean:write name='allsubjects' property="description" /></td>
