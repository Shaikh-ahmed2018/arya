...
<body>
	<div class="col-md-10 col-md-offset-2" id="div-main"
		...
		<p>
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Add New Lab</span>
		</p>
		...
		<form id="SubjectForm" action="subject.html?method=addingLabDetails" method="post" enctype="multipart/form-data" >
				...
				<div class="panel panel-primary">
					<div class="panel-heading clearfix" role="tab" id="headingOne">
							...
							<div class="navbar-right">
								...
								<span id="back" class="buttons" style="margin-left: -5px;margin-right: 1px;">Back</span> 
							</div>
					</div>
						...
						<div class="clearfix">
							<div class="col-md-6" id="txtstyle" style="font-size: 11pt;">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
											<input type="text" style="text-transform: capitalize;" maxlength="25"  name="lab_name" onkeypress="return isNumberKey(event);"  id="lab_name"  class="form-control"    
											value='' />
									</div>
								</div>
							...
							<div class="form-group clearfix">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
											<input type="text" maxlength="4"  name="totalMarks" id="totalMarks" onkeypress="return CheckIsNumeric(event);" class="form-control"    
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
											<input type="text" maxlength="4" name="passMarks" id="passMarks" onkeypress="return CheckIsNumeric(event);" class="form-control" 
