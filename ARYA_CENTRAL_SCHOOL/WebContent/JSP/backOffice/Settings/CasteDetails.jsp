...
<body>
	...
	<div id="dialog"></div>
		...
		<form id="myForm"
			action="adminMenu.html?method=casteDetails" method="post">
			...
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Caste Details
					</h3></a>
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<logic:present name="religionList" scope="request">
						<%-- <display:table class="table" id="allstudent"
							name="religionList"
							requestURI="/adminMenu.html?method=casteDetails">

								<display:column media="html"
								title="<input type='checkbox' name='selectall' id='selectall' onClick='selectAll()' />"><input type='checkbox' name='select' class='select'  value='${allstudent.casteId}' />
								</display:column>
				...
				<table class="table" id="allstudent">
					...
					<logic:iterate name='religionList' id="religionList">
						<tr>
						<td><input type='checkbox' name='select' class='select' style='text-align:center' id='<bean:write name='religionList' property="casteId"/>'/></td>
