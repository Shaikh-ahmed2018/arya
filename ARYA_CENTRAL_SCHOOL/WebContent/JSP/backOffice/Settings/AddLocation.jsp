...
<body>
	<div class="col-md-10 col-md-offset-2" id="div-main"
		...
		<p style="margin-bottom: 5px;margin-top: 5px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading"><logic:present name="Location" scope="request"><bean:write name="Location"></bean:write></logic:present></span>
		</p>
				...
				<div class="panel panel-primary">
					<div class="panel-heading clearfix" role="tab" id="headingOne">
							...
							<div class="navbar-right">
							  ...
							  <span id="back" class="buttons"style="  margin-right:1px;">Back</span>
							</div>
					</div>
							...
							<div class="col-md-6"
								...
								<div class="form-group clearfix">
									<label for="inputEmail" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Location Name</label>
									<div class="col-xs-7">
									<input type="text" name="locationname" onkeypress="HideError()" class="form-control" id="locationname" 
							  ...
							  <div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<textarea style="resize:none" rows="4" cols="25"  class="form-control"
											name="desc" id="descriptionid" ><logic:present name="editlist"><bean:write name="editlist" property="desc"/></logic:present></textarea>
									</div>
								</div>
