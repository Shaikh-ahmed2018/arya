...
<script type="text/javascript"
	src="JS/backOffice/Settings/AddReligion.js"></script>
	...
	<div class="col-md-10 col-md-offset-2" id="div-main"
		...
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			<div class="panel panel-primary" >
				...
				<a href="#" style="color: #767676">	<h4 class="panel-title">
					...
					<div class="panel-body">
					 ...
					 <input type="hidden" name="religionId" class="streamidclass"
					      id="relgnId" value='<logic:present name="religionList"><bean:write name="religionList" property="religionId" />
								...
								<div class="col-xs-7">
									<input type="text" name="religion" id="religionNameId" onkeypress="HideError()"
