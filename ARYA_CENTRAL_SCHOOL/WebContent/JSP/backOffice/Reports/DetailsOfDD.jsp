			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h4 class="panel-title"><i	class="glyphicon glyphicon-menu-hamburger"></i>	&nbsp;&nbsp;DD Reports</h4></a>
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						<div class="panel-body own-panel">
							...
							<div class="col-md-6" style="font-family: Open Sans Light; font-size: 11pt; color: #5d5d5d;border: 1px solid #ccc;padding: 5px;">
								<div class="datewiseSearh">Search DD date Wise</div>
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;">From Date</label>
									<div class="col-xs-7">
										<input type="text" id="startDate" name="startdate" class="form-control" readonly value="" />
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" id="endDate" name="enddate" class="form-control" readonly value="" />
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<span id="search" class="buttons" >search</span>
						...
						<input type="hidden" name="Acyearid" id="Acyearid" value='<logic:present name="Acyearid"><bean:write name="Acyearid"/></logic:present>'></input>
							...
							<div id="individualstudenttable" class="clearfix">
