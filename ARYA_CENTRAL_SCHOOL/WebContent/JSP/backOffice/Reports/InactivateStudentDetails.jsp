...
<body>
	...
	<div class="col-md-10 col-md-offset-2"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span style="font-size: 16pt;">In-Active Student
			</span>
		</p>
				...
				<div class="panel panel-primary">
					...
					<div id="collapseOne" class="panel-collapse collapse in"
						...
						<div class="panel-body" id="tabletxt" style="padding: 15px;">
							...
							<logic:present name="StudentInfoList" scope="request">
						<table class="table" id="allstudent">
							...
							<tbody>
							<logic:iterate id="StudentInfoList" name="studentList">
								<tr>
								<td><bean:write name='StudentInfoList' property="sno"/></td>
								<td><bean:write name="StudentInfoList" property='admissionno'/></td>
								<td><bean:write name="StudentInfoList" property='name'/></td>
								<td><bean:write name="StudentInfoList" property='age'/></td>
								<td><bean:write name="StudentInfoList" property='doj'/></td>
								<td><bean:write name="StudentInfoList" property='fathername'/></td>
								<td><bean:write name="StudentInfoList" property='fathermobno'/></td>
								<td><bean:write name="StudentInfoList" property='mothername'/></td>
								<td><bean:write name="StudentInfoList" property='monthermobno'/></td>
								</tr>
							</logic:iterate>
							</tbody>
						</table>
