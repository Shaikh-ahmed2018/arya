...
<script type="text/javascript"
	src="JS/backOffice/Reports/StudentAttendanceReport.js"></script>
	...
	<form id="stuattnid"
		...
		<div class="col-md-10 col-md-offset-2"
			...
			<p style="margin: 20px 0px;">
				<img src="images/addstu.png" />&nbsp;<span style="font-size: 16pt;">Student
					Attendance </span>
			</p>
			...
			<div class="panel-group" id="accordion" role="tablist"
				...
				<div class="panel panel-primary">
					...
					<div id="collapseOne" class="panel-collapse collapse in"
						...
						<div class="panel-body" id="tabletxt" style="margin-top: 29px;margin-bottom: 19px;">
							...
							<input type="hidden" name="defaultprofile"
									id="hiddenprofile"
						...
						<table class="table" id="allstudent">
							...
							<tbody>
							<logic:iterate id="studentattendanceList" name="studentattendanceList">
								<tr>
								<td><bean:write name='studentattendanceList' property="count"/></td>
								<td><bean:write name="studentattendanceList" property='accyrname'/></td>
								<td><bean:write name="studentattendanceList" property='streamname'/></td>
								<td><bean:write name="studentattendanceList" property='classname'/></td>
								<td><bean:write name="studentattendanceList" property='sectionname'/></td>
								<td><bean:write name="studentattendanceList" property='studentname'/></td>
								<td><bean:write name="studentattendanceList" property='attdancedate'/></td>
								<td><bean:write name="studentattendanceList" property='attendancestatus'/></td>
								</tr>
							</logic:iterate>
							</tbody>
						</table>
