		...
		<div class="panel panel-primary">
			...
			<div id="gradeOne" class="accordion-body collapse in">
				...
				<!-- <div id = "markstable"></div> -->
						...
						<thead>
						<tr>
						<th style="font-size: 15px; text-align: center;" >Exam Code</th>
						<th style="font-size: 15px; text-align: center;">Exam Name</th>
						<th style="font-size: 15px; text-align: center;">Start Date</th>
						<th style="font-size:15px; text-align: center;">End Date
						</th>
					   ...
					   <logic:present name="subjectmarksList" scope="request">
					   	<logic:iterate id="subjectmarksList" name="subjectmarksList" scope="request">
					   		...
					   		<td class=""><bean:write name="subjectmarksList" property="startDate"/></td>
					   		<td class=""><bean:write name="subjectmarksList" property="endDate"/></td>
							<td><span class="<bean:write name="subjectmarksList" property="status"/>"><bean:write name="subjectmarksList" property="status"/></span></td>
					   		</tr>
					   	</logic:iterate>
					   </logic:present>
					   </tbody>
