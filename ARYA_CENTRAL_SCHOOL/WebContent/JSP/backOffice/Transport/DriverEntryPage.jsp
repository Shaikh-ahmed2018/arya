				...
				<div class="panel panel-primary">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<div class="navbar-right" >
									...
									<span id="savedriver" class="buttons" style=" margin-right: -11px;"
 ...
 --%>										<input type="hidden" name="driver_code" id="drivercode" value="<logic:present name="drivercode" ><bean:write name="drivercode" /></logic:present>" />
                               ...
                               <div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										...
										<div class="col-xs-7">
									<input type="text" name="experience" id="experience"  class="form-control" onkeypress="HideError()" maxlength="2"
							...
							<!-- 	<div class="form-group">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										...
										<input type="file" id="uploadlicence" name="licensedrive" class="custom-file-uploadfile form-control" style="height: 20%;" />
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select class="form-control" name="driving_license_types" id="vehicletodrive" onkeypress="HideError()"
											class="form-control">
