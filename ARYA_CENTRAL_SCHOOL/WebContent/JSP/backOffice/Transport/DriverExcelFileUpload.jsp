							...
							<div class="panel-body">
								<div class="col-md-6" id="txtstyle" style="padding: 0;">
									<div class="form-group">
										...
										<div class="col-xs-8">
											<input type="file" name="formFile" id="driverFile"
								...
								<div class="col-md-3" id="txtstyle" style="padding: 10px 0px;">
									<font size="3"><u><a href="uploadDriverXSL.html?method=downloadDriverFileFormat">Click
								...
								<logic:present name="failedDriverList" scope="request">
									<div class="col-md-12"
										...
										<display:table id="allstudent"
											name="requestScope.failedDriverList" class="table"
											requestURI="/uploadDriverXSL.html?method=insertDriverXSL">

											<display:column property="driverName"
												title="Driver Name" headerClass="heading1" style="font-weiht normal;" />
											<display:column property="drivingLicenseNo" title="License No."
												headerClass="heading1" />
											<display:column property="licenseToDrive"
												title="License To Drive" headerClass="heading1" />
