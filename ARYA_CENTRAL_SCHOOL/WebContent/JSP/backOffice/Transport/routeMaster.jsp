...
<body>
	...
	<div class="col-md-10 col-md-offset-2" id="div1">
		...
		<div class="searchWrap">
			...
			<form id="myForm" action="adminMenu.html?method=routeMasterSettings"
				method="post">
				<div class="col-md-5">
		...
		<div class="form-group clearfix">
				...
				<div class="input-group col-md-4">
					...
					<span class="input-group-btn">
						<button class="btn btn-default" type="submit" id="searchid"
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						class="panel-title" id="route" style="color: #767676;vertical-align: text;">
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Route
						Master
					</h3></a>
				<div class="navbar-right">
					<span id="plus" class="buttons">Add</span> <span
						id="editDesignationId" class="buttons">Edit </span> <span
						id="trash" class="buttons" style="margin-left: 8px;">Delete</span>
			...
			<div id="routeclose" class="accordion-body collapse in">
				<div class="panel-body"
					style="font-family: Open Sans Light; font-size: 11pt; color: #5d5d5d;">
					
					<logic:present name="getTpMasterDetails" scope="request">
						<table class="table" id="allstudent">
							...
							<tbody>
							<logic:iterate id="getTpMasterDetails" name="getTpMasterDetails">
								<tr>
								<td><input type='checkbox' name='select' class='select'style='text-align: center' id='<bean:write name="getTpMasterDetails" property='routeCode'/>'/></td>
								<td><bean:write name="getTpMasterDetails" property='routeNo'/></td>
								<td><bean:write name="getTpMasterDetails" property='routeName'/></td>
								<td><bean:write name="getTpMasterDetails" property='stratTime'/></td>
								<td><bean:write name="getTpMasterDetails" property='endTime'/></td>
								<td><bean:write name="getTpMasterDetails" property='totalStops'/></td>
								<td><bean:write name="getTpMasterDetails" property='totalDistance'/></td>
								<td><bean:write name="getTpMasterDetails" property='halttime'/></td>
								</tr>
							</logic:iterate>
							</tbody>
						</table>
