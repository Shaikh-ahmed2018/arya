		...
		<div class="" id="div2">
			...
			<p>
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Transport Term Setup</span>
			</p>
		</div>
			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Transport Term
						List
					</h3></a>
				<div class="navbar-right">
					<a href="transport.html?method=addtSeparateTransportTermdetails"><span
						class="buttons" style="margin-right:12px;">Add</span> </a> 
