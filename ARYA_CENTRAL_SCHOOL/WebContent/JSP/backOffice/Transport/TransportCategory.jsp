...
<script type="text/javascript"
	src="JS/backOffice/Transport/TransportDetails.js"></script>
...
<body>
	...
	<div class="col-md-10 col-md-offset-2" id="div1">
		<div class="searchWrap">
			...
			<form id="myForm" action="adminMenu.html?method=transportCategory"
				method="post">
		...
		<div class="panel panel-primary">
			<div class="panel-heading clearfix">
				...
				<div class="navbar-right">
					<a href="transport.html?method=addTransportType"> <span
				...
				<div class="panel-body"
					...
					<%-- <logic:present name="vehicleTypeList" scope="request">
						<display:table class="table" id="allstudent"
							...
							requestURI="adminMenu.html?method=transportCategory">
							...
							<display:column style="text-align:center"
								...
								<input type='checkbox' name='select' class='select'
									style='text-align: center' id='${allstudent.vehicle_id }' />
							</display:column>

							<display:column property="vehicleType" sortable="true"
								title="Transport Type<img src='images/sort1.png' style='float: right'/>" />
					...
					<logic:present name="vehicleTypeList" scope="request">
						<table class="table" id="allstudent">
							...
							<logic:iterate id="vehicleTypeList" name="vehicleTypeList">
								<tr>
								<td><input type='checkbox' name='select' class='select' style='text-align: center' id='<bean:write name="vehicleTypeList" property='vehicle_id'/>' /></td>
								<td><bean:write name="vehicleTypeList" property='vehicleType'/></td>
...
<div class='pagebanner' style="margin-top: 5px;"><select id='show_per_page'><option value='50'>50</option><option value='100'>100</option><option value='200'>200</option><option value='300'>300</option><option value='400'>400</option><option value='500'>500</option></select>
	<span  class='numberOfItem'></span>	
	</div><div class='pagination pagelinks' style="margin-bottom: 4px"></div>					
