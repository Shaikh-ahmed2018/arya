						...
						<input type="hidden" id="projectId" value="<logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="projectId"/></logic:present>"/>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light" id="addmissionNo"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="classname"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="projectname"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="startdate"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light" id="concessionPercent"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="enddate"/></logic:present>
										</label>
									</div>
								</div>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="sectionname"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12" id="maxmarks"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="maxmarks"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="specialization"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Open Sans Light"><logic:present name="ProjectDetailsVo"><bean:write name="ProjectDetailsVo" property="subjectname"/></logic:present>
										</label>
									</div>
								</div>
							</div>
						
						<display:table class="table allstudent" id="projectList" style="font-family: Open Sans Light; color: #897676;border-top: 2px solid #ddd;"
