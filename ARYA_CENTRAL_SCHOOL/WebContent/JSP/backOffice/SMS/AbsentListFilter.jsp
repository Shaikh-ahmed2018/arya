...
<body>
	<div class="col-md-10 col-md-offset-2"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Send Absent SMS</span>
		</p>
 ...
 --%>
			<div id="collapseOne" class="panel-collapse collapse in"
						...
						<div class="form-group clearfix">
									...
									<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Students</label>
									<div class="col-xs-7">
										
									 
								        <select name="student" multiple id="studentid" onkeypress="HideError()" class="form-control" >
									       <option value=""></option>
									      <%-- <logic:present name="classpojo" scope="request">
										    <logic:iterate id="stream" name="classpojo" scope="request">
											<option value='<bean:write name='stream' property='classId'/>'>
