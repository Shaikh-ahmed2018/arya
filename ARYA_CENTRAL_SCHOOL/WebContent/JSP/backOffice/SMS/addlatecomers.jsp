...
<body>
	<div class="col-md-10 col-md-offset-2"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">LateComers</span>
		</p>
						...
						<div class="panel-body">
							...
							<div class="col-md-6"
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<textarea  readonly="readonly"  name="remarks" id="description" class="form-control" onkeypress="HideError()" style=" width: 100%; height: 108px; margin-top: 0px; margin-bottom:"><logic:present name="driverlist"><bean:write name="driverlist" property="address"/></logic:present></textarea>
									</div>
								</div>
