...
<body>
  ...
  <logic:present name="message" scope="request">
		...
		<form id="uniform" action="smsPath.html?">
			<input type="hidden" name="method" value="SendUniform">
...
&nbsp;
							...
							<span
								class="buttons" >Back</span></a>
						</div>
					</div>

					

					<input type="hidden" name="classname" class="searchtermclass"
						id="hclassid" value="" /> <input type="hidden" name="section"
						...
						<div class="panel-body">
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select name="classnameid" multiple id="classid"
											...
											<logic:present name="classpojo" scope="request">
												<logic:iterate id="stream" name="classpojo" scope="request">
													<option
														value='<bean:write name='stream' property='classId'/>'>
														<bean:write name='stream' property='className' />
													</option>
												</logic:iterate>
											</logic:present>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select name="studentname" multiple id="studentid"
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select name="sectionname" multiple id="sectionid"
											onkeypress="HideError()" class="form-control">
											<!-- <option value=""></option> -->
											<logic:notEmpty name="ALLACCYEARS" scope="request">
												<logic:iterate id="map" name="ALLACCYEARS" scope="request">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<textarea name="smstext" id="smstext" class="form-control"
