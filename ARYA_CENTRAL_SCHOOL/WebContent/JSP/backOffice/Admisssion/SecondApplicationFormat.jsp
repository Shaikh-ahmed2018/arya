...
<option value="West Bengal">West Bengal</option>
								...
								<div class="form-group clearfix">
								<label for="distanceId" class="control-label col-xs-5"
							...
							<div class="form-group clearfix">
								<label for="secondlanguageId" class="control-label col-xs-5"
							...
							<div class="form-group clearfix">
								<label for="thirdlanguageId" class="control-label col-xs-5"
						...
						<fieldset>
							...
							<div class="form-group clearfix" id="hiddenmotheralumniname">
								...
								<div class="col-xs-7" style="margin-left: -12px;">
									<input type="text" class="form-control" name="motherAlumniname"	id="motherAlumniname" maxlength="50" style="width: 315px;" />
								</div>
							</div>
