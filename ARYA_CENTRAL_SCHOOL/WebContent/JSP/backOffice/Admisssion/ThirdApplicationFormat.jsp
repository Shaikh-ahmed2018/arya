				...
				<div class="panel panel-primary">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<a data-toggle="collapse" data-parent="#accordion"
								href="#collapseOne"
								style="color: #767676; vertical-align: text-top;"><h4 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>
								&nbsp;&nbsp;Admission Form 
							</h4></a>
						
						<input type="hidden" name="enquiryid" id="enquiryid" value='<logic:present name="enquiryid" scope="session"><bean:write name="enquiryid" /></logic:present>' />
					...
					<div class="row" style="padding: 10px;">
						<div class="col-md-6" style="font-family: Open Sans Light; font-size: 11pt; color: #5d5d5d;">
                                ...
                                <div class="form-group clearfix">
									<label for="placeOfBirthId" class="control-label col-xs-5" style="text-align: right; line-height: 35px;">Place Of Birth</label>
									<div class="col-xs-7">
...
<option value="West Bengal">West Bengal</option>
								...
								<div class="form-group clearfix">
									<label for="preferedphno" class="control-label col-xs-5"
										style="text-align: right; line-height: 18px;">Preferred Sms No.<font color="red">*</font></label>
									<div class="col-xs-7">
										<input type="text" minlength="10" maxlength="10" class="form-control" name="preferedphno" id="preferedphno" />
							...
							<div class="form-group clearfix">
								<label for="schemeofstudyId" class="control-label col-xs-5"
							...
							<div class="form-group clearfix" id="hiddenanyotherboard">
								<label for="anyotherboardId" class="control-label col-xs-5" style="text-align: right; line-height: 35px;">Any Other State Board<font color="red">*</font></label>
								<div class="col-xs-7">
                            ...
                            <div class="form-group clearfix">
								<label for="qualifyingId" class="control-label col-xs-5"
							...
							<div class="form-group clearfix">
								<label for="activities" class="control-label col-xs-5"
							...
							<div class="form-group clearfix">
								<label for="specilization" class="control-label col-xs-5" style="text-align: right; line-height: 35px;">Group Prefered<font color="red">*</font></label>
								<div class="col-xs-7">
							...
							<div class="form-group clearfix">
								<label for="optionalsubjectId" class="control-label col-xs-5" style="text-align: right; line-height: 35px;">Optional Subject</label>
								<div class="col-xs-7">
						...
						<div class="col-md-6" style="font-family: Open Sans Light; font-size: 11pt; color: #5d5d5d;">
							<div class="form-group clearfix" style="height: 87px;">
								<label for="studentImageId1" class="control-label col-xs-5" style="text-align: right; line-height: 35px;"></label>
									<div class="col-xs-7">
						...
						<div class="form-group clearfix" style="margin-top:20px;">
							<label for="uploadmarksheet" class="control-label col-xs-5"
						...
						<div class="form-group clearfix" style="margin-top:20px;">
							<label for="tcupload" class="control-label col-xs-5"
								style="text-align: right; line-height: 35px;margin-left:-122px;margin-top:2px;">TC Upload</label>
							<div class="col-xs-7">
								<input type="file" id="tcupload" name="tccertificate" class="form-control" style="height: 20%;" /> 
							</div>
						</div>
						<div class="form-group clearfix" style="margin-top:20px;">
							<label for="migrationcertificate" class="control-label col-xs-5"
								style="text-align: right; line-height: 35px;margin-left:-122px;margin-top:2px;">Migration Upload</label>
							<div class="col-xs-7">
								<input type="file" id="migrationcertificate" name="migrationcertificate" class="form-control" style="height: 20%;" /> 
							</div>
						</div>
				</div>
			</div>
