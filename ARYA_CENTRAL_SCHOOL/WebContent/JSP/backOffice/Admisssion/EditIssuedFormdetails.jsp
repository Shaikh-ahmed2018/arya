...
<div id="add" class="tab-pane">
     <div class="col-md-10 col-md-offset-2" id=div-main
		...
		<input type ="hidden" id="updatelocationname" value='<logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist"/></logic:present>' />				
			<input type="hidden" id="updateenquiryid" value='<logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" 
property="enquiryid" />
		</logic:present>'></input>
				...
				<div class="panel panel-primary">
					<div class="panel-heading clearfix" role="tab" id="headingOne">
	                        ...
	                        <div class="navbar-right" >
								 ...
								 <span style="top:3px;"
									 id="save" class="buttons">Save</span>
									<span style="top:3px;"class="buttons" id="back">Back</span>
							</div>
