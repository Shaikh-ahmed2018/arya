...
.rotate {height: 300px;white-space: nowrap;}
.rotate div{transform: translate(0px, -124px) rotate(90deg);width: 30px;text-align: center;}
.wrraper{
max-width:1200px;
overflow:scroll; 
height: 400px; 
}
#second tbody td,#second thead th{border: 1px solid #000;}
</style>
</head>
<body>
			...
			<div id="classOne" class="accordion-body collapse in">
				<div class="panel-body">
					...
					<div class="col-md-6 groupData" id="txtstyle">
						...
						<div class="wrraper" id="printable">
						<table style="width: 100%;" id='second' class='allstudent'>
						<thead>	<tr>
						
								<th class="rotate"><div>SL.NO.</div></th>
								<th class="rotate"><div>HOUSE</div></th>
								<th class="rotate"><div>POSITION</div></th>
								<th class="rotate"><div>Items</div></th>
								<th class="rotate"><div>SUB.TOTAL</div></th>
