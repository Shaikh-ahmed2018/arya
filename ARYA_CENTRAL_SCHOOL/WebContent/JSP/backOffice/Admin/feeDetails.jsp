...
<div class="successmessagediv feedetails" align="center" style="display: none;">
		...
		<div class="panel panel-primary">
			<div class="panel-heading clearfix">
				...
				<div class="navbar-right">
					...
					</a> <span id="feeedit" class="buttons">Edit</span>
				...
				<logic:present name="feelist" scope="request">
						<table class="table" id="allstudent">
							...
							<logic:iterate id="feelist" name="feelist">
								<tr>
								<td><input type='checkbox' name='select' class='select' value='<bean:write name="feelist" property='id'/>'/></td>
								<td><bean:write name="feelist" property='academicYearName'/></td>
