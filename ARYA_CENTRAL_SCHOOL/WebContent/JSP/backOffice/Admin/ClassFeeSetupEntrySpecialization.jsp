					...
					<!-- Term Name -->
						...
						<table class="table classfeesetup" cellpadding="5" cellspacing="0" border="1" width="100%">
							...
							<tr>
								...
								<th style="font-size: 14px; background: #f9f9f9 !important; font-family: Roboto Medium; text-align: right;">SPECIALIZATION  <bean:write name="getTermFee" property="specialization_name"  />-<bean:write name="getTermFee" property="termname"  /> Fees Total</th>
