...
<script type="text/javascript"
	src="JS/backOffice/Staff/StaffExcelFileUpload.js"></script>
						...
						<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="panel-body">
								...
								<div class="col-md-3" id="txtstyle" style="padding: 10px 0px;">
									<font size="3"><u><a href="uploadStaffXSL.html?method=downloadStaffFileFormat">Click
								...
								<logic:present name="failedStaffList" scope="request">
									<div class="col-md-12"
										...
										<display:table id="allstudent"
											name="requestScope.failedStaffList" class="table"
											requestURI="/uploadStaffXSL.html?method=insertStaffXSL">

											<display:column property="firstName" 
												title="Teacher Name" headerClass="heading1" style="font-weiht normal;" />
											<display:column property="mobileNo" title="Mobile No"
												headerClass="heading1" />
											
											<display:column property="designation"
												title="Designation" headerClass="heading1" />
											<display:column property="department"
												title="Department" headerClass="heading1" />
