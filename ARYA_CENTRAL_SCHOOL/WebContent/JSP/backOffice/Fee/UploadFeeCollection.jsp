...
<style>
  #allstudent th:nth-child(5),td:nth-child(6){
 	
  }
  #allstudent th:nth-child(2),th:nth-child(3),th:nth-child(4){
 	min-width:150px;	
  }
 ...
 width: 1200px;
   ...
   #allstudent th:nth-child(5),th:nth-child(6),th:nth-child(7),th:nth-child(8),th:nth-child(9){
 	min-width:80px;	
  }
...
<body>
	<div class="col-md-10 col-md-offset-2" id="div-main" style="font-family: Roboto Medium; font-size: 20pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; margin-top: -6px;">
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Upload Fee Collection Details</span>
		</p>
						...
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" align="center">
							<div class="panel-body">
								...
								<div class="col-md-3" id="txtstyle" style="padding: 10px 0px;">
									<u><a href="feeupload.html?method=downloadfileformat">Click here for Download File Format</a>
									</u>
								</div>
								...
								<logic:present name="FailFeeList" scope="request">
									...
									<div class="col-md-12">
										...
										<display:table id="allstudent" name="requestScope.FailFeeList" class="table" requestURI="/feeupload.html?method=insertFeeXSL">
											<display:column property="stuFname" title="Name" headerClass="heading1" />
											...
											<display:column property="locationName" title="Location" headerClass="heading1" />
