							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUPROMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=NewstudentPromotionList" id="sub_module_2_5">Student Promotion</a></li>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUPROMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=studentConfidentialReport" id="sub_module_2_6">Disciplinary Action</a></li>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUPROMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=StudentAppraisalReport" id="sub_module_2_7">Student Appraisal</a></li>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUPROMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=studentWithheldList" id="sub_module_2_13">Student Withheld</a></li>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=generateRollNo" id="sub_module_2_8">Generate Roll No</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="studentcertificate.html?method=studentCertificates" id="sub_module_2_11">Age & Bonafide Certificates</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=studentfileupload" id="sub_module_2_12">Upload Student Excel Data File</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=tcgeneration" id="sub_module_2_15">TC Generation</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=studentphotoupload" id="sub_module_2_1u">Upload Photo</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="STUPROMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="adminMenu.html?method=studentAppraisalList">Student Appraisal</a></li>
