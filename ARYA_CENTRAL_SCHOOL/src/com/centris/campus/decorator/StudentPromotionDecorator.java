...
public class StudentPromotionDecorator extends TableDecorator {
	...
	public String getcount() {
		String studentid = "";
		StudentRegistrationVo detils = (StudentRegistrationVo) getCurrentRowObject();
		studentid="<span class=\""+detils.getStudentId()+","+detils.getCurrentAccyearId()+","+detils.getLocationId()+","+detils.getAcademicYearId()+"\" >"+detils.getCount()+"</span>";
		return studentid;
	}
